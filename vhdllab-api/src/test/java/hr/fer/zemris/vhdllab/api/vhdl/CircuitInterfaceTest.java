...
public class CircuitInterfaceTest {
    ...
    public void equals() throws Exception {
        ...
        assertFalse("circuit interface is equal to null.", ci.equals(null));
        assertFalse("can compare with string object.", ci
    ...
    public void hashCodeAndEquals3() throws Exception {
        ...
        assertFalse("circuit interfaces are equal.", ci.equals(newCi));
        assertFalse("circuit interfaces are equal.", ci.hashCode() == newCi
                .hashCode());
    }
