...
public class TypeTest {
    ...
    public void equals() throws Exception {
        ...
        assertFalse("type is equal to null.", type.equals(null));
        assertFalse("can compare with string object.", type
    ...
    public void hashCodeAndEquals2() throws Exception {
        ...
        assertFalse("types are equal.", type.equals(newType));
        assertFalse("types are equal.", type.hashCode() == newType.hashCode());
    }
