...
/**
 * This class contains methods which are used for Testbench VHDL generation
 * 
...
public class TestbenchVHDLGenerator implements VHDLGenerator {
     ...
     *             if <code>ci</code> or <code>testedFileName</code> or <code>testBnechFileName</code> or <code>tbInfo</code> is
     *             <code>null</code>.
     * 
     */
    private String generirajVHDL(String testBenchFileName, String testedFileName, CircuitInterface ci,
                                Testbench tbInfo) {
        if (ci == null)
        ...
        if (testBenchFileName == null)
            throw new NullPointerException("TestBench filename can not be null.");
        if (tbInfo == null)
            throw new NullPointerException("TestBench filename can not be null.");
        long TestBenchLength = tbInfo.getTestBenchLength();
        int bufferSize = 0;
        if (tbInfo.getSimulationLength()!=0) TestBenchLength = tbInfo.getSimulationLength();
        ...
        vhdl.append("library IEEE;\n").append("use IEEE.STD_LOGIC_1164.ALL;\n")
                .append("\n").append("entity ").append(testBenchFileName).append(
                        " is \n").append("end ").append(testBenchFileName).append(
                        ";\n").append("\n").append(
                        "architecture structural of ").append(testBenchFileName)
                .append(" is \n");
    ...
    private void populateProcess(CircuitInterface ci, Testbench tbInfo,
        ...
        for (ChangesInMoment slot : list) {
            if (time != -1) {
                vhdl.append("\t\twait for ").append(slot.getTime()/TimeScale.getMultiplier(tbInfo.getTimeScale()) - time/TimeScale.getMultiplier(tbInfo.getTimeScale()))
            ...
            for (ChangeWithSignalName change : slot.getList()) {
                ...
                if (ci.getPort(change.getSignalName()).getType().getRange().isScalar())
        ...
        vhdl.append("\t\twait for ").append(tbInfo.getPeriodLength()/TimeScale.getMultiplier(tbInfo.getTimeScale())).append(" ").append(tbInfo.getTimeScale().toString()).append(";\n");
        vhdl.append("\t\twait;\n");
    ...
    /**
     * Create a process list. This method will create a list of objects ChangesInMoment from where
     * method populateProcess(CircuitInterface, Testbench, StringBuilder) will
     * draw information regarding signal changes written in Testbench.
     * 
     * @param ci
     *            a circuit interface from where to draw information.
     * @param tbInfo
     *            information about testbench from inducement.
     */
    private List<ChangesInMoment> createProcessList(
            CircuitInterface ci, Testbench tbInfo) {
        ...
        for (Signal s : tbInfo.getSignals()) {
            ...
            for (SignalChange i : s.getSignalChangeList(0, TestBenchLength)) {
                ...
                ChangeWithSignalName imp = new ChangeWithSignalName(s
                        .getName(), i);
    ...
    /**
     * This class contains information about each signal change in the particular time moment.
     * It contains time of change and list of ChangeWithSignalName structure.
     * 
     * @author Ivan Kmetovic
     *
     */
    private class ChangesInMoment implements Comparable<ChangesInMoment> {
        ...
        /**
         * Construct an instance of this class using a time. A
         ...
         *         argument; and a value greater than 0 if this object has time
         *         greater than the object argument.
        ...
        /**
         * Compares this object ChangesInMoment to the specified object. Returns <code>true</code>
         * if and only if the specified object is also a <code>ChangesInMoment</code> and
         * if times are the same.
         * 
         * @param o
         *            the object to compare this <code>ChangesInMoment</code> against.
        ...
        /**
         * Returns a hash code value for this <code>ChangesInMoment</code> instance. The
         * hash code of <code>ChangesInMoment</code> instance is hash code of time.
         * <p>
         * This ensures that <code>s1.equals(s2)</code> implies that
         * <code>s1.hashCode() == s2.hashCode()</code> for any two ChangesInMoment objects,
     ...
     * time. It contains of signal name and an class that describes signal change.
     * 
     * @author Ivan Kmetovic
     *
     */
    private class ChangeWithSignalName {
         ...
         * signal change to explain an ChangeWithSignalName. A signal name must have
         ...
         * <code>ChangeWithSignalName</code> and if signal names and described signal changes
         * are the same.
         * 
         * @param o
         *            the object to compare this
         *            <code>ChangeWithSignalName</code> against.
         * @return <code>true</code> if <code>ChangeWithSignalName</code>
