...
public class ResultTest {
    ...
    public void messages2() throws Exception {
        ...
        assertEquals("messages modified.", Collections.emptyList(), newResult
                .getMessages());
        assertFalse("messages modified.", messages.equals(newResult.getMessages()));
    }
    ...
    /**
     * Deserialization returns object of type Result.
     */
    @Test
    public void readResolve2() throws Exception {
        ...
        assertTrue("wrong object type.", readObject.getClass() == Result.class);
