...
public class RangeTest {
    ...
    public void equals() throws Exception {
        ...
        assertFalse("range is equal to null.", range.equals(null));
        assertFalse("can compare with string object.", range
    ...
    public void hashCodeAndEquals2() throws Exception {
        ...
        assertFalse("ranges are equal.", range.equals(newRange));
        assertFalse("ranges are equal.", range.hashCode() == newRange
                .hashCode());
    }
