...
public final class VHDLGenerationResult extends
     ...
     * 
     * @param result
     *            a vhdl generation result to copy
     */
    protected VHDLGenerationResult(VHDLGenerationResult result) {
        super(result);
    }
    ...
    public boolean equals(Object obj) {
         ...
         */
        if (!(obj instanceof VHDLGenerationResult))
            return false;
    ...
    protected Object readResolve() {
        return new VHDLGenerationResult(this);
    }
