...
public final class VHDLGenerationMessage extends Message {
     ...
     * 
     * @param message
     *            a vhdl generation message to copy
     */
    protected VHDLGenerationMessage(VHDLGenerationMessage message) {
        super(message);
    }
    ...
    public boolean equals(Object obj) {
         ...
         */
        if (!(obj instanceof VHDLGenerationMessage))
            return false;
    ...
    protected Object readResolve() {
        return new VHDLGenerationMessage(this);
    }
