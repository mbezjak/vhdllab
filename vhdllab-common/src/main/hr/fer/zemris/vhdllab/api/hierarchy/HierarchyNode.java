...
public final class HierarchyNode implements Serializable {
	...
	/**
	 * A parent to a hierarchy node. It is used to disallow circular
	 * dependencies.
	 */
	private final transient HierarchyNode parent;
	/**
	 ...
	 *             or a circular dependency was found
	 ...
	 *             dependency or a circular dependency was found
	 * @throws IllegalStateException
	 *             if node is no longed mutable
	 */
	private void addDependency(HierarchyNode node) {
		if (!mutable) {
		 ...
		 */
		if (canFormCircularDependency(this, node)) {
	 ...
	 * circular dependency or <code>false</code> otherwise.
	 * <p>
	 ...
	 *            <code>depNode</code>
	 * @param depNode
	 *            a dependency node to test if it can form circular dependency
	 * @return <code>true</code> if circular dependency can form or
	 *         <code>false</code> otherwise
	 */
	private static boolean canFormCircularDependency(HierarchyNode node,
		...
		return canFormCircularDependency(node.parent, depNode);
	}
