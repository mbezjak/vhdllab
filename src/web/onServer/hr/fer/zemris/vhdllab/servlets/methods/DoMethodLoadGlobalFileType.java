...
/**
 * This class represents a registered method for "load global file type" request.
 * 
 * @author Miro Bezjak
 * @see MethodConstants#MTD_LOAD_GLOBAL_FILE_TYPE
 */
public class DoMethodLoadGlobalFileType implements RegisteredMethod {
	...
	public Properties run(Properties p, ManagerProvider mprov) {
		...
		resProp.setProperty(MethodConstants.PROP_FILE_TYPE,file.getType());
		return resProp;
	}
