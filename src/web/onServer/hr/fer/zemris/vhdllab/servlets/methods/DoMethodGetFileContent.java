...
/**
 * This class represents a registered method for "load.file.content" request.
 * 
 * @author Miro Bezjak
 */
public class DoMethodGetFileContent implements JavaToAjaxRegisteredMethod {

	/**
	 * This method is called when "load.file.content" request is received.
	...
	public Properties run(Properties p, HttpServletRequest request, HttpServletResponse response, VHDLLabManager labman) throws IOException {
		...
		resProp.setProperty(MethodConstants.PROP_METHOD,MethodConstants.MTD_LOAD_FILE_CONTENT);
