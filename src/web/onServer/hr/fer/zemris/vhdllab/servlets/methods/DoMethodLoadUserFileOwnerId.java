...
/**
 * This class represents a registered method for "load user file owner id" request.
 * 
 * @author Miro Bezjak
 * @see MethodConstants#MTD_LOAD_USER_FILE_OWNER_ID
 */
public class DoMethodLoadUserFileOwnerId implements RegisteredMethod {
	...
	public Properties run(Properties p, ManagerProvider mprov) {
		...
		resProp.setProperty(MethodConstants.PROP_FILE_OWNER_ID,String.valueOf(file.getOwnerID()));
		return resProp;
	}
