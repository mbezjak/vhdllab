 ...
 * @author Miro Bezjak
 */
public class DoMethodLoadProjectOwnerId implements JavaToAjaxRegisteredMethod {
	...
	public Properties run(Properties p, VHDLLabManager labman) {
		...
		resProp.setProperty(MethodConstants.PROP_METHOD,MethodConstants.MTD_LOAD_PROJECT_OWNER_ID);
