...
public class Content extends JPanel {
	...
	public Content() {
		Person ozegovic = new Person("Boris Ožegoviæ", ozegovicIcon, Description.OZEGOVIC.getString());
		Person bezjak = new Person("Miro Bezjak", bezjakIcon,Description.BEZJAK.getString());
		Person ana = new Person("Ana Vignjeviæ", anaIcon, Description.VIGNJEVIC.getString());
		Person cupic = new Person("Marko Èupiæ", cupicIcon, Description.CUPIC.getString());
		Person delac = new Person("Davor Delaè", delacIcon, Description.DELAC.getString());
		Person prokopec = new Person("Aleksandar Prokopec", prokopecIcon, Description.PROKOPEC.getString());
		Person alic = new Person("Ivan Aliæ", alicIcon, Description.ALIC.getString());
		Person rajakovic = new Person("Tomislav Rajakoviæ", rajakovicIcon, Description.RAJAKOVIC.getString());
		Person cakmak = new Person("Jagor Èakmak", cakmakIcon, Description.CAKMAK.getString());
		Person gjurkovic = new Person("Matej Gjurkoviæ", gjurkovicIcon, Description.GJURKOVIC.getString());
