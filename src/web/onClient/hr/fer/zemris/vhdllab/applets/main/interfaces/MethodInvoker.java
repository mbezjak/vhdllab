...
public interface MethodInvoker {
	...
	Long loadUserFileOwnerId(Long fileId) throws AjaxException;
	...
	Long createUserFile(Long ownerId, String type) throws AjaxException;
	boolean existsUserFile(Long fileId) throws AjaxException;
	void deleteUserFile(Long fileId) throws AjaxException;
	List<Long> findUserFilesByOwner(Long ownerId) throws AjaxException;

	String loadProjectName(Long projectId) throws AjaxException;
	Long loadProjectOwnerId(Long projectId) throws AjaxException;
	...
	Long createProject(String name, Long ownerId) throws AjaxException;
	boolean existsProject(Long projectId) throws AjaxException;
	void deleteProject(Long projectId) throws AjaxException;
	List<Long> findProjectsByUser(Long ownerId) throws AjaxException;
