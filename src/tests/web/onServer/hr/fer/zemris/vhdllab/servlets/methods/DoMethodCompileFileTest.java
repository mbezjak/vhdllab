...
public class DoMethodCompileFileTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodCompileFile();
		method = MethodConstants.MTD_COMPILE_FILE;
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodCompileFileTest.class);
	}
}