...
public class DoMethodLoadProjectNmbrFilesTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadProjectNmbrFiles();
		method = MethodConstants.MTD_LOAD_PROJECT_NMBR_FILES;
	}
	...
	public void run3() {
		...
		assertEquals(String.valueOf(project.getFiles().size()), p.getProperty(MethodConstants.PROP_PROJECT_NMBR_FILES, ""));
	}
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadProjectNmbrFilesTest.class);
	}
}