...
public class DoMethodLoadFileContentTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadFileContent();
		method = MethodConstants.MTD_LOAD_FILE_CONTENT;
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadFileContentTest.class);
	}
}