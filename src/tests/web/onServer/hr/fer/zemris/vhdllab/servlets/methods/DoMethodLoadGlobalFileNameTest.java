...
public class DoMethodLoadGlobalFileNameTest {
	...
	public void run3() {
		...
		assertEquals(file.getName(), p.getProperty(MethodConstants.PROP_FILE_NAME, ""));
	}
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadGlobalFileNameTest.class);
	}
}