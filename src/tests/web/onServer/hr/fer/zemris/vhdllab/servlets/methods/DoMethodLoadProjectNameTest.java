...
public class DoMethodLoadProjectNameTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadProjectName();
		method = MethodConstants.MTD_LOAD_PROJECT_NAME;
	}
	...
	public void run3() {
		...
		assertEquals(project.getProjectName(), p.getProperty(MethodConstants.PROP_PROJECT_NAME, ""));
	}
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadProjectNameTest.class);
	}
}