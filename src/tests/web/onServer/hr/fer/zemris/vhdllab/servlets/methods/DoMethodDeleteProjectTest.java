...
public class DoMethodDeleteProjectTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodDeleteProject();
		method = MethodConstants.MTD_DELETE_PROJECT;
	}
	...
	public void run3() throws ServiceException {
		...
		assertEquals(false, labman.existsProject(project.getId()));
	}
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodDeleteProjectTest.class);
	}
}