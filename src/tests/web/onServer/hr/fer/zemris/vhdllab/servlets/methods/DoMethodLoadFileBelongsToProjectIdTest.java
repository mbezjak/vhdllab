...
public class DoMethodLoadFileBelongsToProjectIdTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadFileBelongsToProjectId();
		method = MethodConstants.MTD_LOAD_FILE_BELONGS_TO_PROJECT_ID;
	}
