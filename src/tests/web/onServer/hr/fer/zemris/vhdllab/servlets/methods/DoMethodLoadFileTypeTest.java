...
public class DoMethodLoadFileTypeTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadFileType();
		method = MethodConstants.MTD_LOAD_FILE_TYPE;
	}
	...
	public void run3() {
		...
		assertEquals(file1.getFileType(), p.getProperty(MethodConstants.PROP_FILE_TYPE, ""));
	}
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadFileTypeTest.class);
	}
}