...
public class DoMethodLoadFileNameTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadFileName();
		method = MethodConstants.MTD_LOAD_FILE_NAME;
	}
	...
	public void run3() {
		...
		assertEquals(file1.getFileName(), p.getProperty(MethodConstants.PROP_FILE_NAME, ""));
	}
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadFileNameTest.class);
	}
}