...
public class DoMethodRenameProjectTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodRenameProject();
		method = MethodConstants.MTD_RENAME_PROJECT;
	}
	...
	@Test
	public void run2() {
		prop.setProperty(MethodConstants.PROP_PROJECT_NAME, "NewTestProjectName");
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodRenameProjectTest.class);
	}
}
