...
public class DoMethodLoadGlobalFileContentTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodLoadGlobalFileContent();
		method = MethodConstants.MTD_LOAD_GLOBAL_FILE_CONTENT;
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodLoadGlobalFileContentTest.class);
	}
}