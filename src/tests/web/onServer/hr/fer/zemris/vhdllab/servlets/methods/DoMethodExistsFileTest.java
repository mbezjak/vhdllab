...
public class DoMethodExistsFileTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodExistsFile();
		method = MethodConstants.MTD_EXISTS_FILE;
	}
	...
	@Test
	public void run3() {
		prop.setProperty(MethodConstants.PROP_FILE_NAME, String.valueOf(file1.getFileName()));
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodExistsFileTest.class);
	}
}