...
public class DoMethodRenameGlobalFileTest {
	...
	public static void init() throws ServiceException {
		...
		regMethod = new DoMethodRenameGlobalFile();
		method = MethodConstants.MTD_RENAME_GLOBAL_FILE;
	}
	...
	@Test
	public void run2() {
		prop.setProperty(MethodConstants.PROP_FILE_NAME, "NewTestFileName");
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DoMethodRenameGlobalFileTest.class);
	}
}
