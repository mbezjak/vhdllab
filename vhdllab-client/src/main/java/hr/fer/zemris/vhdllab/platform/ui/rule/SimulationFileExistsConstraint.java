...
public class SimulationFileExistsConstraint extends AbstractPropertyConstraint {

    private static final long serialVersionUID = 1L;

    private final WorkspaceManager workspaceManager;

    public SimulationFileExistsConstraint(WorkspaceManager workspaceManager) {
    ...
    protected boolean test(PropertyAccessStrategy access) {
        ...
        String simulationName = (String) access.getPropertyValue("simulationName");
        // File type and data is irrelevant
        File file = new File(simulationName, FileType.SIMULATION, "");
