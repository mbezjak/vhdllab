...
public class DefaultProjectExplorer extends JPanel implements IProjectExplorer {
    ...
    private Icon inverse = new ImageIcon(getClass().getClassLoader()
            .getResource("icons/hierarchy_xusedbyy_32.png"));
    private Icon flatIcon = new ImageIcon(getClass().getClassLoader()
            .getResource("icons/hierarchy_flat_32.png"));
    ...
    class VHDLCellRenderer extends DefaultTreeCellRenderer {
        ...
        private Icon vhdl = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_source_16.png"));
        private Icon predefined = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_predefined_16.png"));
        private Icon tb = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_testbench_16.png"));
        private Icon automat = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_automaton_16.png"));
        private Icon schema = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_schema_16.png"));
        private Icon simulation = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_simulation_16.png"));
        private Icon project = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/project_16.png"));
        private Icon defaultIcon = new ImageIcon(getClass().getClassLoader()
                .getResource("icons/file_16.png"));
        ...
        public Component getTreeCellRendererComponent(JTree tree, Object value,
            ...
            } else if (FileType.PREDEFINED.equals(type)) {
                setIcon(predefined);
                setToolTipText("Predefined file");
            } else if (FileType.TESTBENCH.equals(type)) {
                setIcon(tb);
                setToolTipText("Testbench");
            } else if (FileType.AUTOMATON.equals(type)) {
                setIcon(automat);
                setToolTipText("Automat");
            } else if (FileType.SCHEMA.equals(type)) {
                setIcon(schema);
                setToolTipText("Schema");
            } else if (FileType.SIMULATION.equals(type)) {
                setIcon(simulation);
    ...
    private void addProject(Caseless projectName) {
        ...
        if (getNode(root, projectName) == null) {
            projectNode = new PeNode(projectName.toString());
    ...
    private void buildXusedInYForOneProject(Caseless projectName,
        ...
        for (Caseless string : hierarchy.getTopLevelFiles()) {
            ...
            if (children.isEmpty()) {
                ...
                nodesUsesLeaf.add(string.toString());
        ...
        for (Caseless child : children) {
            ...
            if (childChildren.isEmpty()) {
                ...
                if (leafsInTree.containsKey(child)) {
                    ...
                    node = new PeNode(child.toString());
                    leafsInTree.put(child.toString(), node);
                ...
                nodesUsesLeaf.add(child.toString());
