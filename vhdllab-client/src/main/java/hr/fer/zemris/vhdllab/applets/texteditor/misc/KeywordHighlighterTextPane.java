...
public class KeywordHighlighterTextPane extends JTextPane {
	...
	public KeywordHighlighterTextPane() {
		...
		styleMap.put("ARRAY", kwStyle);
		styleMap.put("ASSERT", kwStyle);
		styleMap.put("ATTRIBUTE", kwStyle);
		styleMap.put("BEGIN", kwStyle);
		styleMap.put("BLOCK", kwStyle);
		styleMap.put("BIT", typeStyle);
		styleMap.put("BUFFER", kwStyle);
		styleMap.put("BUS", kwStyle);
		styleMap.put("CASE", kwStyle);
		styleMap.put("COMPONENT", kwStyle);
		styleMap.put("CONFIGURATION", kwStyle);
		styleMap.put("CONSTANT", kwStyle);
		styleMap.put("DOWNTO", kwStyle);
		styleMap.put("ELSE", kwStyle);
		styleMap.put("ELSIF", kwStyle);
		styleMap.put("END", kwStyle);
		styleMap.put("EXIT", kwStyle);
		styleMap.put("ENTITY", kwStyle);
		styleMap.put("FOR", kwStyle);
		styleMap.put("FUNCTION", kwStyle);
		styleMap.put("GENERATE", kwStyle);
		styleMap.put("GENERIC", kwStyle);
		styleMap.put("GUARDED", kwStyle);
		styleMap.put("IF", kwStyle);
		styleMap.put("IN", kwStyle);
		styleMap.put("INERTIAL", kwStyle);
		styleMap.put("INOUT", kwStyle);
		styleMap.put("IS", kwStyle);
		styleMap.put("LIBRARY", kwStyle);
		styleMap.put("LOOP", kwStyle);
		styleMap.put("MAP", kwStyle);
		styleMap.put("NAND", operStyle);
		styleMap.put("NEXT", operStyle);
		styleMap.put("NOR", operStyle);
		styleMap.put("NOT", operStyle);
		styleMap.put("NULL", operStyle);
		styleMap.put("OF", kwStyle);
		styleMap.put("ON", kwStyle);
		styleMap.put("OPEN", kwStyle);
		styleMap.put("OR", operStyle);
		styleMap.put("OTHERS", kwStyle);
		styleMap.put("OUT", kwStyle);
		styleMap.put("PACKAGE", kwStyle);
		styleMap.put("PORT", kwStyle);
		styleMap.put("PROCEDURE", kwStyle);
		styleMap.put("PROCESS", kwStyle);
		styleMap.put("RANGE", kwStyle);
		styleMap.put("RECORD", kwStyle);
		styleMap.put("REGISTER", kwStyle);
		styleMap.put("RETURN", kwStyle);
		styleMap.put("SIGNAL", kwStyle);
		styleMap.put("SHARED", kwStyle);
		styleMap.put("SUBTYPE", kwStyle);
		styleMap.put("STD_LOGIC", typeStyle);
		styleMap.put("STD_LOGIC_VECTOR", typeStyle);
		styleMap.put("THEN", kwStyle);
		styleMap.put("TO", kwStyle);
		styleMap.put("TRANSPORT", kwStyle);
		styleMap.put("TYPE", kwStyle);
		styleMap.put("UNTIL", kwStyle);
		styleMap.put("USE", kwStyle);
		styleMap.put("VARIABLE", kwStyle);
		styleMap.put("WAIT", kwStyle);
		styleMap.put("WHEN", kwStyle);
		styleMap.put("WHILE", kwStyle);
		styleMap.put("WITH", kwStyle);
		styleMap.put("XNOR", operStyle);
