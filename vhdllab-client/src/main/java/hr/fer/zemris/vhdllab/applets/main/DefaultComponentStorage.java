...
public class DefaultComponentStorage implements IComponentStorage {
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#add(hr
     * .fer
     ...
     */
    @Override
    public boolean add(IComponentIdentifier<?> identifier,
            ComponentGroup group, String title, JComponent component,
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#remove
     * (hr.
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#moveComponent
     * (
     ...
     * (non-Javadoc)
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#
     * getComponentPlacement(javax.swing.JComponent)
     */
    @Override
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#
     * getIdentifierFor(javax.swing.JComponent)
     */
    @Override
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#getComponent
     * (
     * hr.fer.zemris.vhdllab.applets.main.componentIdentifier.IComponentIdentifier
     * )
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#getComponents
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#
     * getSelectedComponent(hr.fer.zemris.vhdllab.applets.main.ComponentGroup)
     */
    @Override
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#contains
     * (hr
     * .fer.zemris.vhdllab.applets.main.componentIdentifier.IComponentIdentifier
     * )
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#setTitle
     * (hr
     * .fer.zemris.vhdllab.applets.main.componentIdentifier.IComponentIdentifier
     * , java.lang.String)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#getTitleFor
     * (
     * hr.fer.zemris.vhdllab.applets.main.componentIdentifier.IComponentIdentifier
     * )
     */
     ...
     */
    @Override
    public void setToolTipText(IComponentIdentifier<?> identifier,
            String tooltip) {
        if (identifier == null) {
            throw new NullPointerException("Identifier cant be null");
        }
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IComponentStorage#
     * getComponentCountFor(hr.fer.zemris.vhdllab.applets.main.ComponentGroup)
     */
    @Override
