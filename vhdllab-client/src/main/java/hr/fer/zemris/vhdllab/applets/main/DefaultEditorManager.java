...
public class DefaultEditorManager implements IEditorManager {
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#openPreferences
     * ()
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#viewVHDLCode
     * (
     ...
     * openEditorByResource
     * (hr.fer.zemris.vhdllab.applets.main.componentIdentifier
    ...
    public IEditor openEditor(IComponentIdentifier<?> identifier,
        ...
        String[] replacements = new String[] {
                content.getFileName() != null ? content.getFileName()
                        .toString() : "none",
                content.getProjectName() != null ? content.getProjectName()
                        .toString() : "none", tooltipSpecial };
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#getOpenedEditor
     * (
     * hr.fer.zemris.vhdllab.applets.main.componentIdentifier.IComponentIdentifier
     * )
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#saveAllEditors
     * ()
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#saveEditors
     * (java.util.List)
     */
     ...
     *            an editor to save
     * @param tryExplicitly
     *            <code>true</code> if this method should try to save an editor
     *            explicitly if it is not savable
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#closeEditor
     * (hr.fer.zemris.vhdllab.applets.main.interfaces.IEditor)
     */
     ...
     *            an editor to close
     * @param shouldSave
     *            <code>true</code> if an editor should be saved before closing
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#closeAllEditors
     * ()
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#closeEditors
     * (java.util.List)
     */
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#
     * saveResourcesWithDialog(java.util.List)
     */
    @Override
    public boolean saveResourcesWithDialog(List<IEditor> openedEditors,
        ...
        if (!notSavedEditors.isEmpty()) {
            ...
            boolean shouldAutoSave = pref.getBoolean(name, false);
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#isEditorOpened
     * (hr.fer.zemris.vhdllab.applets.main.interfaces.IEditor)
     */
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#
     * getOpenedEditorsThatHave(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IEditorManager#getTitle
     * (hr.fer
    ...
    class EditorModifiedListener implements EditorListener {
         ...
         * 
         * @see
         * hr.fer.zemris.vhdllab.applets.main.event.EditorListener#modified(
         * java.lang.String, java.lang.String, boolean)
         */
        @Override
        public void modified(Caseless projectName, Caseless fileName,
                boolean flag) {
