...
/**
 * Direct copy of {@link org.springframework.richclient.application.support.AboutBox} with some modifications:
 * <ul>
 * <li>added UTF-8 encoding when reading aboutTextPath</li>
 * <li>changed font to JTextArea txtDescriptor</li>
 * <li>increased height of dialogPanel.preferredSize to 550 pixels</li>
 * <li>added serialVersionUID to HtmlScroller to avoid warning</li>
 * </ul>
 * 
 * @author Miro Bezjak
 * @version 1.0
...
public class AboutBox {
    ...
    protected class AboutDialog extends ApplicationDialog {
        ...
        protected JComponent createApplicationDescriptorComponent() {
            ...
            txtDescriptor.setFont(new Font("Verdana", Font.PLAIN, 11)); // 19.09.2010 added different font
            ...
            if( aboutTextPath != null ) {
                try {
                    ...
                    String text = FileCopyUtils.copyToString(new BufferedReader(new InputStreamReader(aboutTextPath
                            .getInputStream(), "UTF-8"))); // 19.09.2010 added UTF-8
                ...
                dialogPanel.setPreferredSize(new Dimension(scroller.getPreferredSize().width, 550));  // 19.09.2010 increased size from 300 to 550 pixels
            } else {
    ...
    protected static class HtmlScroller extends JViewport implements HyperlinkListener {
        ...
        private static final long serialVersionUID = 9119949044332804060L; // 19.09.2010 added to avoid warning
