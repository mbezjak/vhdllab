...
//                "./src/web/onClient/hr/fer/zemris/vhdllab/applets/simulations/proba.vcd");
//        parser.parse();
//
//        FileContent fileContent = new FileContent("proba", "nana", parser
//                .getResultInString());
...
//        Console.run(new TestClass(), 1024, 1000);
        System.err.println("NOT IMPLEMENTED BECAUSE ITS BROKEN!");
        System.exit(-1);
    }
}
