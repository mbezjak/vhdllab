...
public class DefaultViewManager implements IViewManager {
     ...
     * (non-Javadoc)
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#
     * openProjectExplorer()
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#openView(hr
     * .fer
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#getOpenedView
     * (hr
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#closeView(
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IView)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#closeAllViews
     * ()
     */
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#
     * closeAllButThisView(hr.fer.zemris.vhdllab.applets.main.interfaces.IView)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#closeViews
     * (java.util.List)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#isViewOpened
     * (hr.fer.zemris.vhdllab.applets.main.interfaces.IView)
     */
     ...
     * 
     * @seehr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#
     * findAllViewsAssociatedWith(java.lang.Object)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#getAllOpenedViews
     * ()
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#getSelectedView
     * ()
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#getTitle(hr
     * .fer
     * .zemris.vhdllab.applets.main.componentIdentifier.IComponentIdentifier)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#setTitle(hr
     * .fer.zemris.vhdllab.applets.main.interfaces.IView, java.lang.String)
     */
     ...
     * 
     * @see
     * hr.fer.zemris.vhdllab.applets.main.interfaces.IViewManager#getIdentifierFor
     * (hr.fer.zemris.vhdllab.applets.main.interfaces.IView)
     */
    ...
    private ComponentPlacement getPlacement(IComponentIdentifier<?> identifier) {
        ...
        Preferences pref = Preferences
                .userNodeForPackage(DefaultViewManager.class);
        String name = UserFileConstants.SYSTEM_COMPONENT_PLACEMENT_FOR + id;
        String property = pref.get(name, null);
        if (property == null) {
            if (identifier.equals(ComponentIdentifierFactory
                    .createProjectExplorerIdentifier())) {
                property = ComponentPlacement.LEFT.name();
            } else {
                property = pref.get(
                        UserFileConstants.SYSTEM_DEFAULT_VIEW_PLACEMENT,
                        ComponentPlacement.BOTTOM.name());
            }
