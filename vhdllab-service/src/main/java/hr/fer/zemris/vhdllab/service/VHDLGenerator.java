...
/**
 * VHDL generators generate VHDL code out of a specified file. All VHDL
 * generators must have an empty public default constructor for proper
 * initialization.
 * <p>
 ...
 * </p>
 * <p>
 * A generator implementation should be stateless! Meaning that repeated
 * invocation of {@link #generateVHDL(File)} method on the same object instance
 * should return the same result as if it was invoked on different object
 * instance.
 * </p>
 * <p>
 * A generator implementation should also be deterministic! Meaning that
 * repeated invocation of the same file parameter should return the same result.
 * </p>
 * 
 * @author Miro Bezjak
 * @version 1.0
