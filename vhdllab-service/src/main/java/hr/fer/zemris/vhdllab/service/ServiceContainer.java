...
public final class ServiceContainer extends ServerContainer {
    ...
    /**
     * Reference to single instance of service container (singleton pattern).
     */
    private static final ServiceContainer INSTANCE = new ServiceContainer(
            DAOContainer.instance());

    /**
     * Constructs a service container.
     */
    private ServiceContainer(DAOContainer container) {
        super(container);
    ...
    /**
     * Returns an instance of service container. Repeated invocation of this
     * method will return the same object instance. Return value will never be
     * <code>null</code>.
     *
     * @return an instance of service container
     */
